...
for n_iter in range(25):
    ...
    for ii in np.arange(EP_LEN):
        ...
        # print(f"action_choose_mat:{action_choosen_mat}")
        # a0
        # ONE STEP: r0
        next_state, r, info = env.step_w_o_request(action_tuple, 2)
        # r0
